...
export default async function AdminMatchWeeksPage() {
    ...
    return (
        <div className="p-6">
            <h1 className="text-4xl font-bold tracking-tight text-apur-green text-center">Listado de Jornadas</h1>
            <p className="text-center text-neutral-500 text-sm mt-2">Todas las jornadas activas de la liga</p>
            <CreateButton />
