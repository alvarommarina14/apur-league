    ...
    return (
        <div className="w-full px-4 py-12 bg-neutral-50 min-h-[calc(100dvh-4rem)] flex flex-col items-center">
            ...
            <p className="text-gray-600 mb-6">
                Fecha de nacimiento:{' '}
                <span className="font-semibold text-gray-900">{format(player.dateOfBirth, 'DD-MM-YYYY', 'es')}</span>
            </p>

            <section className="mb-8">
                <h2 className="text-2xl font-semibold text-apur-green mb-2">Categorías Activas</h2>
            ...
            <section>
                <h2 className="text-2xl font-semibold text-apur-green mb-2">Partidos Jugados</h2>
